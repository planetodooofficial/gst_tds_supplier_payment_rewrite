...
class GSTReturn(models.Model):
    ...
    def get_invoice_action(self):
        ...
        action = self.env.ref('gst_tds_supplier_payment_rewrite.customer_invoice_list_action').read()[0]
    ...
    def action_view_attachment(self):
        ...
        action = self.env.ref('gst_tds_supplier_payment_rewrite.gst_attachments_action').read()[0]
    ...
    def generate_documents(self):
        ...
        return {
            ...
            'view_id': self.env.ref('gst_tds_supplier_payment_rewrite.wizard_message_form').id,
            'res_id': partial.id,
